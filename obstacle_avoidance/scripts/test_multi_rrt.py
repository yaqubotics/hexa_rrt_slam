    ...
    for i in range(0,NUM_OF_NODES):
        for a in range(0,NUM_OF_AGENT):
            ...
            while(not node_added):
                ...
                #print i,a
                #print lines
                if(LineOfSight(walls,nn,newnode) and (not is_line_intersect_with_lines(lines,(nn,newnode)))):
                    agent_nodes[a].append(newnode)
                    #nodes_and_parent.append((nn,newnode))
                    agent_tree[a][newnode]=nn
